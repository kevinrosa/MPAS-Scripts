...
%     pcolor(x, time, ssh(:,xi,eta) - time_mean); shading flat
    ...
    set(gca,'fontsize',14,'ydir','normal','xdir','normal')
...
%     line(position, time, 'linewidth',2,'color',0.3*[1,1,1]);
    ...
    save_name = sprintf('figures/westward_propogation/hovmoeller_atl_%s_v3',run(i).short_name);
    set(gca,'color','none');
...
save_name = 'figures/westward_propogation/hovmoeller_atl_colorbar_v3.png';
