...
set(gcf,'color','w')
set(gca,'color','none');
export_fig('figures/spectra/trackline_04.png', '-m3','-painters','-transparent')
%
%
...
for F = {'temperatureAtSurface', 'ssh'}
    ...
    % SAVE
    set(gca,'color','none');
    export_fig(sprintf('figures/spectra/spectra_hanning_v03_%s.png',field), '-m3','-painters','-transparent')
end
