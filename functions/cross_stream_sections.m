function [flux, angle, lon, lat] = cross_stream_sections(mesh_fi, data_fi, cont, lon_vec, lat_vec, width)
...
[SSH.x, SSH.y, SSH.field] = curv_to_meshgrid(SSH.x1, SSH.y1, SSH.field1);
