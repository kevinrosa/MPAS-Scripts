...
for F = {'trans_swbc','trans_dwbc','trans_rest'}
    ...
    save_name = sprintf('figures/transport/bars_%s_%.1fE_v0.png', field, llon);
...
save_name = sprintf('figures/transport/map_bathy_line_30N_v1.png');
set(gca,'color','none');
export_fig(save_name, '-m3','-painters','-transparent')
...
save_name = sprintf('figures/transport/cross-sec_bathy_line_30N_v1.png');
% set(gca,'color','none');
export_fig(save_name, '-m3','-painters')%,'-transparent')
